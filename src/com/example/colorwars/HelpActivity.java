...
public class HelpActivity extends Activity implements OnClickListener {
	...
	protected void onResume() {
		...
		abar = (TextView) findViewById(R.id.tvmainhelph);
		abar.setTypeface(font);
		float sts = abar.getTextSize();
		abar.setTextSize(sts
			...
			Thread timer1 = new Thread() {
				public void run() {
					try {
						...
						Intent About = new Intent(context, BPlay.class);
						startActivity(About);
					}
				}
			};
			...
			Thread timer2 = new Thread() {
				public void run() {
					try {
						...
						Intent About = new Intent(context, PUps.class);
						startActivity(About);
					}
				}
			};
			...
			Thread timer3 = new Thread() {
				public void run() {
					try {
						...
						Intent About = new Intent(context, HTwin.class);
						startActivity(About);
					}
				}
			};
			...
			Thread timer4 = new Thread() {
				public void run() {
					try {
						...
						Intent About = new Intent(context, CSoon.class);
						startActivity(About);
					}
				}
			};
